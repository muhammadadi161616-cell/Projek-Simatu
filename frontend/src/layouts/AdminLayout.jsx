...
const AdminLayout = () => {
    ...
    const getPageTitle = () => {
        ...
        if (path === '/admin/tasks') return 'Manajemen Semua Tugas';
        if (path === '/admin/logs') return 'Log Aktivitas Sistem';
        return 'Panel Admin';
    };
        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-slate-900">
                <div className="flex flex-col items-center gap-3">
                    ...
                    <span className="text-sm font-semibold text-slate-400">Memuat Sesi Admin...</span>
                </div>
            </div>
        );
    }

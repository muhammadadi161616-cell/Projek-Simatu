...
import { RefreshCw, History, Calendar, CheckSquare, Shield } from 'lucide-react';
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white border border-slate-200 p-6 rounded-3xl shadow-sm">
                <div className="space-y-1">
                    <div className="flex items-center gap-2">
                        ...
                        {user?.role === 'admin' && (
                            <span className="flex items-center gap-1 px-2 py-0.5 text-[10px] font-bold text-red-700 bg-red-50 border border-red-100 rounded-full">
                    ...
                    <p className="text-sm text-slate-400 font-medium">
                        {user?.role === 'admin' 
                            ? 'Anda memegang akses penuh untuk mengelola semua tugas pengguna.' 
                            : 'Kelola tugas harian Anda dan pantau produktivitas.'}
                    </p>
                </div>
                <button
                                ...
                                <div key={log.id} className="flex flex-col sm:flex-row sm:items-center justify-between py-3.5 gap-2">
                                    <div className="space-y-0.5">
                                        ...
                                        <div className="flex items-center gap-2 text-xs text-slate-400 font-medium">
                                            <span>Oleh: {log.user_name || log.user_id}</span>
                                            <span>•</span>
                ...
                <div className="p-6 bg-white border border-slate-200 rounded-3xl shadow-sm lg:col-span-1 flex flex-col justify-between">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3.5 text-xs font-medium text-slate-500 leading-relaxed">
                            ...
                            <p>
                                Gunakan menu <strong>Tugas</strong> untuk melakukan tambah, ubah, dan hapus tugas Anda. Perubahan status tugas akan dicatat di dalam <strong>Riwayat</strong> aktivitas secara real-time.
                            </p>
                        </div>
                    </div>

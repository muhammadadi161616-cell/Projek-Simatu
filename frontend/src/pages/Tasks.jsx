    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h2 className="text-xl sm:text-2xl font-extrabold text-slate-800 tracking-tight">Daftar Tugas</h2>
                    <p className="text-sm text-slate-400 font-medium">Buat dan kelola tugas di sini secara efisien.</p>
                </div>
                <button
